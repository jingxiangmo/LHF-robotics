...
bool xarm_msgs__srv__move_cartesian__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xarm_msgs.srv._move_cartesian.MoveCartesian_Request", full_classname_dest, 51) == 0);
  }
  xarm_msgs__srv__MoveCartesian_Request * ros_message = _ros_message;
  {  // pose
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->pose.data;
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * xarm_msgs__srv__move_cartesian__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MoveCartesian_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("xarm_msgs.srv._move_cartesian");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveCartesian_Request");
  ...
  xarm_msgs__srv__MoveCartesian_Request * ros_message = (xarm_msgs__srv__MoveCartesian_Request *)raw_ros_message;
  {  // pose
    PyObject * field = NULL;
    ...
    if (ros_message->pose.size > 0) {
      ...
      float * src = &(ros_message->pose.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->pose.size * sizeof(float));
      assert(data != NULL);
...
ROSIDL_GENERATOR_C_EXPORT
bool xarm_msgs__srv__move_cartesian__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xarm_msgs.srv._move_cartesian.MoveCartesian_Response", full_classname_dest, 52) == 0);
  }
  xarm_msgs__srv__MoveCartesian_Response * ros_message = _ros_message;
  {  // ret
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * xarm_msgs__srv__move_cartesian__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MoveCartesian_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("xarm_msgs.srv._move_cartesian");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveCartesian_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  xarm_msgs__srv__MoveCartesian_Response * ros_message = (xarm_msgs__srv__MoveCartesian_Response *)raw_ros_message;
  {  // ret
    PyObject * field = NULL;
