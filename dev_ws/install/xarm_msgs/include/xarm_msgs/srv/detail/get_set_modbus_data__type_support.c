...
void GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_init_function(
...
void GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_fini_function(void * message_memory)
{
  xarm_msgs__srv__GetSetModbusData_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_message_member_array[6] = {
  {
    "modbus_data",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_message_members = {
  "xarm_msgs__srv",  // message namespace
  "GetSetModbusData_Request",  // message name
  6,  // number of fields
  sizeof(xarm_msgs__srv__GetSetModbusData_Request),
  GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_message_member_array,  // message members
  GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_message_type_support_handle = {
  0,
  &GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, GetSetModbusData_Request)() {
  if (!GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_message_type_support_handle.typesupport_identifier) {
    GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetSetModbusData_Request__rosidl_typesupport_introspection_c__GetSetModbusData_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_fini_function(void * message_memory)
{
  xarm_msgs__srv__GetSetModbusData_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_message_member_array[3] = {
  {
    "ret",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_INT16,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_message_members = {
  "xarm_msgs__srv",  // message namespace
  "GetSetModbusData_Response",  // message name
  3,  // number of fields
  sizeof(xarm_msgs__srv__GetSetModbusData_Response),
  GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_message_member_array,  // message members
  GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_message_type_support_handle = {
  0,
  &GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, GetSetModbusData_Response)() {
  if (!GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_message_type_support_handle.typesupport_identifier) {
    GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetSetModbusData_Response__rosidl_typesupport_introspection_c__GetSetModbusData_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
