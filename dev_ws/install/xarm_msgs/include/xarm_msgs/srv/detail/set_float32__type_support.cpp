...
{
  new (message_memory) xarm_msgs::srv::SetFloat32_Request(_init);
}

void SetFloat32_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xarm_msgs::srv::SetFloat32_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetFloat32_Request_message_member_array[1] = {
  {
    ...
    offsetof(xarm_msgs::srv::SetFloat32_Request, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetFloat32_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(xarm_msgs::srv::SetFloat32_Request),
...
{
  return &::xarm_msgs::srv::rosidl_typesupport_introspection_cpp::SetFloat32_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, SetFloat32_Request)() {
  return &::xarm_msgs::srv::rosidl_typesupport_introspection_cpp::SetFloat32_Request_message_type_support_handle;
}
...
void SetFloat32_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) xarm_msgs::srv::SetFloat32_Response(_init);
}

void SetFloat32_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xarm_msgs::srv::SetFloat32_Response *>(message_memory);
  typed_message->~SetFloat32_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SetFloat32_Response_message_member_array[2] = {
  {
    "ret",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xarm_msgs::srv::SetFloat32_Response, ret),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xarm_msgs::srv::SetFloat32_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetFloat32_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(xarm_msgs::srv::SetFloat32_Response),
...
{
  return &::xarm_msgs::srv::rosidl_typesupport_introspection_cpp::SetFloat32_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, SetFloat32_Response)() {
  return &::xarm_msgs::srv::rosidl_typesupport_introspection_cpp::SetFloat32_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetFloat32_service_members = {
  ...
  // see get_service_type_support_handle<xarm_msgs::srv::SetFloat32>()
...
get_service_type_support_handle<xarm_msgs::srv::SetFloat32>()
{
  ...
  auto service_type_support =
    &::xarm_msgs::srv::rosidl_typesupport_introspection_cpp::SetFloat32_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, SetFloat32)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<xarm_msgs::srv::SetFloat32>();
}
