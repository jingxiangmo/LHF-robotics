  ...
  xarm_msgs__srv__SetInt32ByType_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xarm_msgs__srv__SetInt32ByType_Request * data =
      (xarm_msgs__srv__SetInt32ByType_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarm_msgs__srv__SetInt32ByType_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xarm_msgs__srv__SetInt32ByType_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  xarm_msgs__srv__SetInt32ByType_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xarm_msgs__srv__SetInt32ByType_Response * data =
      (xarm_msgs__srv__SetInt32ByType_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarm_msgs__srv__SetInt32ByType_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xarm_msgs__srv__SetInt32ByType_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
