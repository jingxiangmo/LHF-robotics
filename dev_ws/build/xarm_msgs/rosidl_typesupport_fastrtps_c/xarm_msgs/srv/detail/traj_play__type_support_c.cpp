  ...
  void * untyped_ros_message)
{
  ...
  _TrajPlay_Request__ros_msg_type * ros_message = static_cast<_TrajPlay_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: filename
  {
    std::string tmp;
    cdr >> tmp;
...
{
  return max_serialized_size_xarm_msgs__srv__TrajPlay_Request(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  _TrajPlay_Response__ros_msg_type * ros_message = static_cast<_TrajPlay_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: ret
  {
    cdr >> ros_message->ret;
  }
...
{
  return max_serialized_size_xarm_msgs__srv__TrajPlay_Response(
    full_bounded, 0);
}
