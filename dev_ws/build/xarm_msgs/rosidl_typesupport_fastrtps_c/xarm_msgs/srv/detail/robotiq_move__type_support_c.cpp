...
static size_t _RobotiqMove_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__RobotiqMove_Request(
    full_bounded, 0);
}
...
static size_t _RobotiqMove_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__RobotiqMove_Response(
    full_bounded, 0);
}
