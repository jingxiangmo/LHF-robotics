  ...
  void * untyped_ros_message)
{
  ...
  _GripperMove_Request__ros_msg_type * ros_message = static_cast<_GripperMove_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: pos
  {
    cdr >> ros_message->pos;
  }
...
{
  return max_serialized_size_xarm_msgs__srv__GripperMove_Request(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  _GripperMove_Response__ros_msg_type * ros_message = static_cast<_GripperMove_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: ret
  {
    cdr >> ros_message->ret;
  }
...
{
  return max_serialized_size_xarm_msgs__srv__GripperMove_Response(
    full_bounded, 0);
}
