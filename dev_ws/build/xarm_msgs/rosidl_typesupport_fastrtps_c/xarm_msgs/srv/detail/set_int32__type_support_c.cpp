...
#include "xarm_msgs/srv/detail/set_int32__rosidl_typesupport_fastrtps_c.h"
...
using _SetInt32_Request__ros_msg_type = xarm_msgs__srv__SetInt32_Request;
...
size_t get_serialized_size_xarm_msgs__srv__SetInt32_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetInt32_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xarm_msgs__srv__SetInt32_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t max_serialized_size_xarm_msgs__srv__SetInt32_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_xarm_msgs__srv__SetInt32_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, SetInt32_Request)() {
...
using _SetInt32_Response__ros_msg_type = xarm_msgs__srv__SetInt32_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t get_serialized_size_xarm_msgs__srv__SetInt32_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetInt32_Response__ros_msg_type * ros_message = static_cast<const _SetInt32_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_xarm_msgs__srv__SetInt32_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t max_serialized_size_xarm_msgs__srv__SetInt32_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_xarm_msgs__srv__SetInt32_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, SetInt32_Response)() {
...
// already included above
// #include "xarm_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "xarm_msgs/srv/set_int32.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, SetInt32)() {
