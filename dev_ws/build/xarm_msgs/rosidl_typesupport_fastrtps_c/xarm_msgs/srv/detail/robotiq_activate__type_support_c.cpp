  ...
  void * untyped_ros_message)
{
  ...
  _RobotiqActivate_Request__ros_msg_type * ros_message = static_cast<_RobotiqActivate_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: wait
  {
    uint8_t tmp;
    cdr >> tmp;
...
static size_t _RobotiqActivate_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__RobotiqActivate_Request(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  _RobotiqActivate_Response__ros_msg_type * ros_message = static_cast<_RobotiqActivate_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: ret
  {
    cdr >> ros_message->ret;
  }
...
static size_t _RobotiqActivate_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__RobotiqActivate_Response(
    full_bounded, 0);
}
