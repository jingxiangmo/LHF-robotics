  ...
  void * untyped_ros_message)
{
  ...
  // Field name: modbus_data
  {
    ...
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->modbus_data, size)) {
      return "failed to create array for field 'modbus_data'";
    }
    auto array_ptr = ros_message->modbus_data.data;
...
static size_t _GetSetModbusData_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__GetSetModbusData_Request(
    full_bounded, 0);
}
...
static size_t _GetSetModbusData_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__GetSetModbusData_Response(
    full_bounded, 0);
}
