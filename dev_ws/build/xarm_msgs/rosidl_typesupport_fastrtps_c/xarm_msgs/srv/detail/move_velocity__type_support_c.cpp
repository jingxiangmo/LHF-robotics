  ...
  void * untyped_ros_message)
{
  ...
  // Field name: speeds
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->speeds, size)) {
      return "failed to create array for field 'speeds'";
    }
    auto array_ptr = ros_message->speeds.data;
...
static size_t _MoveVelocity_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__MoveVelocity_Request(
    full_bounded, 0);
}
...
static size_t _MoveVelocity_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__MoveVelocity_Response(
    full_bounded, 0);
}
