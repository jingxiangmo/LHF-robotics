  ...
  void * untyped_ros_message)
{
  ...
  // Field name: m
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->m, size)) {
      return "failed to create array for field 'm'";
    }
    auto array_ptr = ros_message->m.data;
    cdr.deserializeArray(array_ptr, size);
  }
  ...
  // Field name: b
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->b, size)) {
      return "failed to create array for field 'b'";
    }
    auto array_ptr = ros_message->b.data;
    cdr.deserializeArray(array_ptr, size);
  }
...
static size_t _FtImpedance_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__FtImpedance_Request(
    full_bounded, 0);
}
...
static size_t _FtImpedance_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__FtImpedance_Response(
    full_bounded, 0);
}
