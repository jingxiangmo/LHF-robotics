...
static size_t _VacuumGripperCtrl_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__VacuumGripperCtrl_Request(
    full_bounded, 0);
}
...
static size_t _VacuumGripperCtrl_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_xarm_msgs__srv__VacuumGripperCtrl_Response(
    full_bounded, 0);
}
