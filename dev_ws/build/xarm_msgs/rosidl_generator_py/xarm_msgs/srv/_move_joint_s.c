...
bool xarm_msgs__srv__move_joint__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xarm_msgs.srv._move_joint.MoveJoint_Request", full_classname_dest, 43) == 0);
  }
  xarm_msgs__srv__MoveJoint_Request * ros_message = _ros_message;
  {  // angles
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * xarm_msgs__srv__move_joint__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MoveJoint_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("xarm_msgs.srv._move_joint");
  ...
  xarm_msgs__srv__MoveJoint_Request * ros_message = (xarm_msgs__srv__MoveJoint_Request *)raw_ros_message;
  {  // angles
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool xarm_msgs__srv__move_joint__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xarm_msgs.srv._move_joint.MoveJoint_Response", full_classname_dest, 44) == 0);
  }
  xarm_msgs__srv__MoveJoint_Response * ros_message = _ros_message;
  {  // ret
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * xarm_msgs__srv__move_joint__response__convert_to_py(void * raw_ros_message)
{
  ...
  xarm_msgs__srv__MoveJoint_Response * ros_message = (xarm_msgs__srv__MoveJoint_Response *)raw_ros_message;
  {  // ret
    PyObject * field = NULL;
