...
xarm_msgs__srv__SetDigitalIO_Request__init(xarm_msgs__srv__SetDigitalIO_Request * msg)
{
  ...
  if (!rosidl_runtime_c__float__Sequence__init(&msg->xyz, 0)) {
    xarm_msgs__srv__SetDigitalIO_Request__fini(msg);
    return false;
  }
  // tol_r
  return true;
...
xarm_msgs__srv__SetDigitalIO_Request__create()
{
  ...
  xarm_msgs__srv__SetDigitalIO_Request * msg = (xarm_msgs__srv__SetDigitalIO_Request *)allocator.allocate(sizeof(xarm_msgs__srv__SetDigitalIO_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xarm_msgs__srv__SetDigitalIO_Request));
  bool success = xarm_msgs__srv__SetDigitalIO_Request__init(msg);
  if (!success) {
...
xarm_msgs__srv__SetDigitalIO_Request__Sequence__init(xarm_msgs__srv__SetDigitalIO_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarm_msgs__srv__SetDigitalIO_Request * data = NULL;

  if (size) {
    data = (xarm_msgs__srv__SetDigitalIO_Request *)allocator.zero_allocate(size, sizeof(xarm_msgs__srv__SetDigitalIO_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xarm_msgs__srv__SetDigitalIO_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        xarm_msgs__srv__SetDigitalIO_Request__fini(&data[i - 1]);
      }
...
xarm_msgs__srv__SetDigitalIO_Request__Sequence__fini(xarm_msgs__srv__SetDigitalIO_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      xarm_msgs__srv__SetDigitalIO_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarm_msgs__srv__SetDigitalIO_Request__Sequence * array = (xarm_msgs__srv__SetDigitalIO_Request__Sequence *)allocator.allocate(sizeof(xarm_msgs__srv__SetDigitalIO_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xarm_msgs__srv__SetDigitalIO_Request__Sequence__init(array, size);
  if (!success) {
...
xarm_msgs__srv__SetDigitalIO_Request__Sequence__destroy(xarm_msgs__srv__SetDigitalIO_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xarm_msgs__srv__SetDigitalIO_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xarm_msgs__srv__SetDigitalIO_Request__Sequence__are_equal(const xarm_msgs__srv__SetDigitalIO_Request__Sequence * lhs, const xarm_msgs__srv__SetDigitalIO_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xarm_msgs__srv__SetDigitalIO_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xarm_msgs__srv__SetDigitalIO_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xarm_msgs__srv__SetDigitalIO_Request);
    xarm_msgs__srv__SetDigitalIO_Request * data =
      (xarm_msgs__srv__SetDigitalIO_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarm_msgs__srv__SetDigitalIO_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xarm_msgs__srv__SetDigitalIO_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!xarm_msgs__srv__SetDigitalIO_Request__copy(
...
xarm_msgs__srv__SetDigitalIO_Response__init(xarm_msgs__srv__SetDigitalIO_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    xarm_msgs__srv__SetDigitalIO_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarm_msgs__srv__SetDigitalIO_Response * msg = (xarm_msgs__srv__SetDigitalIO_Response *)allocator.allocate(sizeof(xarm_msgs__srv__SetDigitalIO_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xarm_msgs__srv__SetDigitalIO_Response));
  bool success = xarm_msgs__srv__SetDigitalIO_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
xarm_msgs__srv__SetDigitalIO_Response__Sequence__init(xarm_msgs__srv__SetDigitalIO_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarm_msgs__srv__SetDigitalIO_Response * data = NULL;

  if (size) {
    data = (xarm_msgs__srv__SetDigitalIO_Response *)allocator.zero_allocate(size, sizeof(xarm_msgs__srv__SetDigitalIO_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xarm_msgs__srv__SetDigitalIO_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        xarm_msgs__srv__SetDigitalIO_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
xarm_msgs__srv__SetDigitalIO_Response__Sequence__fini(xarm_msgs__srv__SetDigitalIO_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      xarm_msgs__srv__SetDigitalIO_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarm_msgs__srv__SetDigitalIO_Response__Sequence * array = (xarm_msgs__srv__SetDigitalIO_Response__Sequence *)allocator.allocate(sizeof(xarm_msgs__srv__SetDigitalIO_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xarm_msgs__srv__SetDigitalIO_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
xarm_msgs__srv__SetDigitalIO_Response__Sequence__destroy(xarm_msgs__srv__SetDigitalIO_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xarm_msgs__srv__SetDigitalIO_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xarm_msgs__srv__SetDigitalIO_Response__Sequence__are_equal(const xarm_msgs__srv__SetDigitalIO_Response__Sequence * lhs, const xarm_msgs__srv__SetDigitalIO_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xarm_msgs__srv__SetDigitalIO_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xarm_msgs__srv__SetDigitalIO_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xarm_msgs__srv__SetDigitalIO_Response);
    xarm_msgs__srv__SetDigitalIO_Response * data =
      (xarm_msgs__srv__SetDigitalIO_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarm_msgs__srv__SetDigitalIO_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xarm_msgs__srv__SetDigitalIO_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!xarm_msgs__srv__SetDigitalIO_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
