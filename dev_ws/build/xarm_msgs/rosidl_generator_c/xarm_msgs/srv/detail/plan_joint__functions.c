...
xarm_msgs__srv__PlanJoint_Request__create()
{
  ...
  xarm_msgs__srv__PlanJoint_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xarm_msgs__srv__PlanJoint_Request * data =
      (xarm_msgs__srv__PlanJoint_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarm_msgs__srv__PlanJoint_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xarm_msgs__srv__PlanJoint_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
xarm_msgs__srv__PlanJoint_Response__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ...
  xarm_msgs__srv__PlanJoint_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xarm_msgs__srv__PlanJoint_Response * data =
      (xarm_msgs__srv__PlanJoint_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarm_msgs__srv__PlanJoint_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xarm_msgs__srv__PlanJoint_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
