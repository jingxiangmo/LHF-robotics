...
{
  return max_serialized_size_RobotiqReset_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_RobotiqReset_Response(full_bounded, 0);
}
...
static rosidl_service_type_support_t _RobotiqReset__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
