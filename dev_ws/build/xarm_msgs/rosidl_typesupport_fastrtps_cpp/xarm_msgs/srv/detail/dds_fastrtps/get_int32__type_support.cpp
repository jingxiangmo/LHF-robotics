...
#include "xarm_msgs/srv/detail/get_int32__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xarm_msgs::srv::GetInt32_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xarm_msgs::srv::GetInt32_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const xarm_msgs::srv::GetInt32_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xarm_msgs::srv::GetInt32_Request *>(
    untyped_ros_message);
...
{
  return &xarm_msgs::srv::typesupport_fastrtps_cpp::_GetInt32_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, GetInt32_Request)() {
  return &xarm_msgs::srv::typesupport_fastrtps_cpp::_GetInt32_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xarm_msgs
cdr_serialize(
  const xarm_msgs::srv::GetInt32_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: ret
  cdr << ros_message.ret;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xarm_msgs::srv::GetInt32_Response & ros_message)
{
  // Member: ret
  cdr >> ros_message.ret;
...
{
  auto typed_message =
    static_cast<const xarm_msgs::srv::GetInt32_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xarm_msgs::srv::GetInt32_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xarm_msgs::srv::typesupport_fastrtps_cpp::_GetInt32_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, GetInt32_Response)() {
  return &xarm_msgs::srv::typesupport_fastrtps_cpp::_GetInt32_Response__handle;
}
...
{
  return &xarm_msgs::srv::typesupport_fastrtps_cpp::_GetInt32__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, GetInt32)() {
  return &xarm_msgs::srv::typesupport_fastrtps_cpp::_GetInt32__handle;
}
