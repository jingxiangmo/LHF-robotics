...
{
  return max_serialized_size_RobotiqActivate_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_RobotiqActivate_Response(full_bounded, 0);
}
...
static rosidl_service_type_support_t _RobotiqActivate__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
