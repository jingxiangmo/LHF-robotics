...
static const _VacuumGripperCtrl_Request_type_support_symbol_names_t _VacuumGripperCtrl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, VacuumGripperCtrl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, VacuumGripperCtrl_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, VacuumGripperCtrl_Request)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::VacuumGripperCtrl_Request_message_type_support_handle;
}
...
static const _VacuumGripperCtrl_Response_type_support_symbol_names_t _VacuumGripperCtrl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, VacuumGripperCtrl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, VacuumGripperCtrl_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_xarm_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, VacuumGripperCtrl_Response)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::VacuumGripperCtrl_Response_message_type_support_handle;
}
...
static const _VacuumGripperCtrl_type_support_symbol_names_t _VacuumGripperCtrl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, VacuumGripperCtrl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, VacuumGripperCtrl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, VacuumGripperCtrl)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::VacuumGripperCtrl_service_type_support_handle;
}
