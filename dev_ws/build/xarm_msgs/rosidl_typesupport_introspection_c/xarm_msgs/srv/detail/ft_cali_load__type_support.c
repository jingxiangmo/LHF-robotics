...
void FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_init_function(
...
void FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_fini_function(void * message_memory)
{
  xarm_msgs__srv__FtCaliLoad_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_message_member_array[6] = {
  {
    "datas",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_message_members = {
  "xarm_msgs__srv",  // message namespace
  "FtCaliLoad_Request",  // message name
  6,  // number of fields
  sizeof(xarm_msgs__srv__FtCaliLoad_Request),
  FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_message_member_array,  // message members
  FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_message_type_support_handle = {
  0,
  &FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, FtCaliLoad_Request)() {
  if (!FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_message_type_support_handle.typesupport_identifier) {
    FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &FtCaliLoad_Request__rosidl_typesupport_introspection_c__FtCaliLoad_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_fini_function(void * message_memory)
{
  xarm_msgs__srv__FtCaliLoad_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_message_member_array[2] = {
  {
    "ret",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_message_members = {
  "xarm_msgs__srv",  // message namespace
  "FtCaliLoad_Response",  // message name
  2,  // number of fields
  sizeof(xarm_msgs__srv__FtCaliLoad_Response),
  FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_message_member_array,  // message members
  FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_message_type_support_handle = {
  0,
  &FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, FtCaliLoad_Response)() {
  if (!FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_message_type_support_handle.typesupport_identifier) {
    FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &FtCaliLoad_Response__rosidl_typesupport_introspection_c__FtCaliLoad_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
