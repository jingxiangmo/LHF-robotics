...
void FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_init_function(
...
void FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_fini_function(void * message_memory)
{
  xarm_msgs__srv__FtImpedance_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_message_member_array[5] = {
  {
    "coord",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_message_members = {
  "xarm_msgs__srv",  // message namespace
  "FtImpedance_Request",  // message name
  5,  // number of fields
  sizeof(xarm_msgs__srv__FtImpedance_Request),
  FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_message_member_array,  // message members
  FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_message_type_support_handle = {
  0,
  &FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, FtImpedance_Request)() {
  if (!FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_message_type_support_handle.typesupport_identifier) {
    FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &FtImpedance_Request__rosidl_typesupport_introspection_c__FtImpedance_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_fini_function(void * message_memory)
{
  xarm_msgs__srv__FtImpedance_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_message_member_array[2] = {
  {
    "ret",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_INT16,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_message_members = {
  "xarm_msgs__srv",  // message namespace
  "FtImpedance_Response",  // message name
  2,  // number of fields
  sizeof(xarm_msgs__srv__FtImpedance_Response),
  FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_message_member_array,  // message members
  FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_message_type_support_handle = {
  0,
  &FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, FtImpedance_Response)() {
  if (!FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_message_type_support_handle.typesupport_identifier) {
    FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &FtImpedance_Response__rosidl_typesupport_introspection_c__FtImpedance_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
